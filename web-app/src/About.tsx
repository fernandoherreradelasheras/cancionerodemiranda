...
const About = () => (
    <section className="about">
        ...
        <Image width="60%" src="/header1.jpg" preview={false}
            alt="Comienzo del tono «Un imposible me mata» en el librete del tiple 1º del Cancionero de Miranda"></Image>
        <div style={{ width: "75%" }} className="about-text">
            ...
            <p>Para la edición del cancionero estamos utilizando y desarrollando diferentes herramientas con el fin de ofrecer
                ...
                y el texto de la forma que mejor se adapte a sus circunstancias, ya sean intérpretes, investigadores, musicólogos
            ...
            <p>Así, un musicólogo puede estar muy interesado en ver las correcciones y cambios frente al manuscrito de manera cómoda
                ...
                que permite elegir el número de versos a mostrar, las correcciones y notas editoriales in situ o incluso deshacer los cambios
            ...
            <p>Otra novedad interesante es el uso de un reproductor de audio con interpretaciones de los tonos mediante
                software. Estas versiones hacen uso de cantantes virtuales y no solo facilitan el trabajo de edición en temas
                ...
                la partitura con una animación de scroll infinito.</p>
            ...
            <p>Para la reconstrucción de la voz perdida de alto, además del trabajo tradicional de recomposición, en el que están colaborando
                diversos musicólogos, se está experimentando con el uso de diferentes modelos de inteligencia artificial.
                La tarea de completar una voz que se ha de ceñir a unas reglas específicas y a la vez considerar casos fuera de las
                pautas establecidas es un interesante reto para estas tecnologías. Las primeras de estas reconstrucciones se pueden ya activar
            ...
            <p>El <NavLink to="/tonos/">listado de tonos</NavLink>, accesible también desde el menú de la
