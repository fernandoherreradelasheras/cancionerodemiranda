...
xmlstarlet ed  -P -N mei="http://www.music-encoding.org/ns/mei"  -d '//mei:app[@type="dissonant_analysis" or mei:rdg[@type="dissonant_analysis"]]' "$1" | xmlstarlet ed  -P -N mei="http://www.music-encoding.org/ns/mei"  -d '//mei:harm' > $TMP/clean.mei
...
python3 -m converter21 -f mei -t humdrum $TMP/filtered_flattened.mei  $TMP/filtered.krn
