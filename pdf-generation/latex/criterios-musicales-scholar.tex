...
\noindent Las sílabas que se cantan sobre más de una nota, que en el original se indican mediante una ligadura o semimínimas agrupadas, se indican en la transcripción siempre con una ligadura entre las notas y un guion bajo continuo en el texto de cada una de las notas posteriores a la primera. 
