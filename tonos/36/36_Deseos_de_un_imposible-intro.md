...
[^primaveras]: La *Primavera y flor* conoció varias reediciones (Madrid 1626, Lisboa 1626, Madrid 1641, Madrid 1659), todas descendientes de la edición príncipe de 1621. Las variantes menores (Madrid 1626 «vive», «menos mal»; Madrid 1659 «me falte») son innovaciones de imprenta dentro de esa rama, sin valor para reconstruir el arquetipo.
...
*[TODO: confirmar texto del US-NYhsa B2477]*
...
- **C13** «Desengaños solicito» (solo en *A*)
- **C14** «Porque jamás el olvido» (solo en *A*)
- **C15** «Mi atrevido pensamiento» (solo en *A*)
...
|-----|------------|
| C1,&nbsp;v.&nbsp;3 | «no teniendo remedio» (*A*, *LC*, *M*, *N*) / «no hallando remedio» (*Bc*, *PF*) |
| C2, v. 1 | «passos al viento» (*A*, *N*) / «pasos perdidos» (*Bc*, *LC*, *M*, *PF*) |
| C2, v. 2 | «toda es aire» (*LC*, *M*) / «todo es aire» (*A*, *Bc*, *N*, *PF*) |
| C2, v. 3 | «siguiendo (a) mi pensamiento» (*A*, *N*) / «que sigo mi pensamiento» (*Bc*, *LC*, *M*, *PF*) |
| C2, v. 4 | «no es posible alcanzarle» (*Bc*, *LC*, *M*, *N*, *PF*) / «y es imposible alcançarle» (*A*; cruce aislado, no afecta al agrupamiento de α) |
| C3, v. 4 | «menos mal el matarme» (*A*, *N*) / «menos mal que matarme» (*Bc*, *PF*) / «menor mal que matarme» (*M*) / «menor mal que me maten» (*LC*) |
| C4, v. 3 | «pierdo pasos y deseos» (*LC*, *M*, *N*, *PF*) / «pierdo gustos y deseos» (*Bc*); *A* carece de C4 |
| C5, v. 3 | «la mayor pena» (*LC*, *M*, *N*, *PF*) / «la mayor gloria» (*Bc*) |
| C5, v. 4 | «la pena me falte» (*Bc*, *M*, *PF*) / «las penas me falten» (*LC*, *N*); variante trivial para la filiación general, aunque útil como indicio local de no copia directa |

Las variantes sustantivas de C2 y C3 trazan una bipartición nítida:

- **Familia α = {*A*, *N*}.** Comparten lecciones exclusivas: «passos al viento», «siguiendo (a) mi pensamiento» y «menos mal el matarme». Presentan una recensión amplificada y moralizante sobre las «dificultades» del logro amoroso: *N* añade la copla propia C9 («Que pretensiones tan nobles… que engendra dificultades»), y *A* amplía el romance con cinco coplas exclusivas (C11–C15), terminando en «Mi atrevido pensamiento», que retoma el mismo motivo de C9 con idéntica rima en «dificultades».
- **Familia β**, subdividida en dos subfamilias por innovaciones propias:
...
Estas fechas ordenan cronológicamente los testimonios datables en dos extremos. *PF*, *LC* y *A* ocupan la zona temprana, de los años veinte y treinta; *Bc* queda en la zona tardía, en el último tercio del siglo. *Bc* resulta así una copia tardía de una lección temprana, ya que transmite, junto con *PF*, la innovación «no hallando remedio» que define la subfamilia β1, impresa ya en 1621. Su fecha avanzada no contradice la filiación, sino que muestra que esa rama siguió copiándose hasta el final del siglo.
...
Las tres señales de autoría presentes en el conjunto de los testimonios tienen pesos muy desiguales: la inclusión en *La Circe*, la rúbrica de MSS/3700 y la atribución a Esquilache de B2477. A ellas hay que sumar, a modo de contexto previo, el anonimato de la *Primavera y flor*, que es casi neutro, porque las antologías del romancero nuevo imprimen sus piezas sin nombre de autor por sistema, aun cuando este fuera conocido (Lope, Góngora o Liñán circulan anónimos en esos mismos repertorios). La inclusión en *La Circe* es, en cambio, la prueba de mayor peso, pues se trata de un libro autorizado y publicado por el propio Lope, que intercala el romance, cantado en una novela suya. Esta inclusión no se puede interpretar como una autoatribución porque Lope insertaba también versos ajenos o tradicionales en su prosa y en su teatro, así que hemos de considerarla como un indicio fuerte de la autoría de Lope, pero no una demostración cerrada. La rúbrica «Lope de Bega» de MSS/3700, tomada en solitario, sería frágil, ya que las atribuciones de los cancioneros manuscritos son inestables y el nombre de Lope atraía hacia sí poemas anónimos. La atribución a Esquilache del US-NYhsa B2477 es la más débil de todas y puede descartarse, pues descansa en una nota de procedencia vaga sobre un códice misceláneo «que decían ser versos de Esquilache», algo confirmable al menos para varios sonetos, pero no para los romances.
