...
#verovio --unit "$unit" --multi-rest-style auto --mdiv-all -a --mm-output  --mnum-interval 0  --bottom-margin-header 2.5 --page-margin-left 150 --page-margin-right 150 --page-margin-top 50 --bottom-margin-header 8 --page-margin-bottom 50 --top-margin-pg-footer 4  --header auto --footer encoded --no-justification --breaks auto --condense encoded --min-last-justification 1.0 -o $DIR/output.svg "$input"
